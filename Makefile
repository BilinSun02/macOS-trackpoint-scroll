...
SRC := src/mac_trackpoint_scroll.c src/cursor_pin.c src/config.c src/quartz_suppression.c core/src/engine.c core/src/profiles.c
...
$(BIN): $(SRC) src/config.h core/include/trackpoint_scroll/engine.h core/include/trackpoint_scroll/profiles.h
	@mkdir -p build
