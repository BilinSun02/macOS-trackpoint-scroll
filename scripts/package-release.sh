...
# Sign nested code first, then the app bundle. Ad-hoc signing gives the release
# valid Mach-O signatures without requiring a Developer ID or any certificate
# on the destination Mac.
codesign --force --sign - "$BUNDLE_HELPER"
